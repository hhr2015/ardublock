package com.ardublock.translator.block.layer;
...
public class Conv_A extends TranslatorBlock {

	public Conv_A(Long blockId, Translator translator, String codePrefix, String codeSuffix, String label) {

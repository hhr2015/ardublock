...
public class GenerateCodeButtonListener implements ActionListener
{
	...
	private ResourceBundle uiMessageBundle = Utils.getLangResourceBundle(); 
	...
	{
		//originGenerate(context,workspace,parentFrame);
		CodeChecker.checkCode();		
		CodeGenerator.genCode(context,workspace,parentFrame);
	}

	private void originGenerate(Context context2, Workspace workspace2, JFrame parentFrame2) {
		boolean success;
		success = true;
